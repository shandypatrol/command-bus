...
``` bash
$ composer require shandy-patrol/command-bus
```
...
[ico-travis]: https://img.shields.io/travis/shandypatrol/command-bus/master.svg?style=flat-square
